...
class PolicyResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..pc<ResourceIdentifier>(1, _omitFieldNames ? '' : 'principals', $pb.PbFieldType.PM, subBuilder: ResourceIdentifier.create)
    ...
    ..pc<ResourceIdentifier>(3, _omitFieldNames ? '' : 'resources', $pb.PbFieldType.PM, subBuilder: ResourceIdentifier.create)
...
class ResourceIdentifier extends $pb.GeneratedMessage {
  ...
  factory ResourceIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ResourceIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResourceIdentifier copyWith(void Function(ResourceIdentifier) updates) => super.copyWith((message) => updates(message as ResourceIdentifier)) as ResourceIdentifier;
  ...
  static $pb.PbList<ResourceIdentifier> createRepeated() => $pb.PbList<ResourceIdentifier>();
  @$core.pragma('dart2js:noInline')
  static ResourceIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ResourceIdentifier>(create);
...
class ResourceDeclareRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceDeclareRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..oo(0, [10, 11, 12, 13, 14, 15, 16, 17])
    ..aOM<ResourceIdentifier>(1, _omitFieldNames ? '' : 'id', subBuilder: ResourceIdentifier.create)
    ...
    ..aOM<TopicResource>(12, _omitFieldNames ? '' : 'topic', subBuilder: TopicResource.create)
    ..aOM<KeyValueStoreResource>(13, _omitFieldNames ? '' : 'keyValueStore', subBuilder: KeyValueStoreResource.create)
    ..aOM<SecretResource>(14, _omitFieldNames ? '' : 'secret', subBuilder: SecretResource.create)
    ..aOM<ApiResource>(15, _omitFieldNames ? '' : 'api', subBuilder: ApiResource.create)
    ..aOM<ApiSecurityDefinitionResource>(16, _omitFieldNames ? '' : 'apiSecurityDefinition', subBuilder: ApiSecurityDefinitionResource.create)
    ..aOM<QueueResource>(17, _omitFieldNames ? '' : 'queue', subBuilder: QueueResource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set id(ResourceIdentifier v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(12)
  set topic(TopicResource v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set keyValueStore(KeyValueStoreResource v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set secret(SecretResource v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set api(ApiResource v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set apiSecurityDefinition(ApiSecurityDefinitionResource v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set queue(QueueResource v) { setField(17, v); }
  @$pb.TagNumber(17)
...
class BucketResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BucketResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class TopicResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TopicResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class QueueResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueueResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class KeyValueStoreResource extends $pb.GeneratedMessage {
  ...
  factory KeyValueStoreResource.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory KeyValueStoreResource.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyValueStoreResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  KeyValueStoreResource clone() => KeyValueStoreResource()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyValueStoreResource copyWith(void Function(KeyValueStoreResource) updates) => super.copyWith((message) => updates(message as KeyValueStoreResource)) as KeyValueStoreResource;
  ...
  static $pb.PbList<KeyValueStoreResource> createRepeated() => $pb.PbList<KeyValueStoreResource>();
  @$core.pragma('dart2js:noInline')
  static KeyValueStoreResource getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyValueStoreResource>(create);
...
class SecretResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ApiOpenIdConnectionDefinition extends $pb.GeneratedMessage {
  ...
  factory ApiOpenIdConnectionDefinition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApiOpenIdConnectionDefinition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiOpenIdConnectionDefinition', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ApiOpenIdConnectionDefinition clone() => ApiOpenIdConnectionDefinition()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApiOpenIdConnectionDefinition copyWith(void Function(ApiOpenIdConnectionDefinition) updates) => super.copyWith((message) => updates(message as ApiOpenIdConnectionDefinition)) as ApiOpenIdConnectionDefinition;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ApiOpenIdConnectionDefinition create() => ApiOpenIdConnectionDefinition._();
  ApiOpenIdConnectionDefinition createEmptyInstance() => create();
  static $pb.PbList<ApiOpenIdConnectionDefinition> createRepeated() => $pb.PbList<ApiOpenIdConnectionDefinition>();
  @$core.pragma('dart2js:noInline')
  static ApiOpenIdConnectionDefinition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApiOpenIdConnectionDefinition>(create);
...
enum ApiSecurityDefinitionResource_Definition {
  oidc, 
  notSet
}
...
class ApiSecurityDefinitionResource extends $pb.GeneratedMessage {
  ...
  factory ApiSecurityDefinitionResource.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApiSecurityDefinitionResource.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ApiSecurityDefinitionResource_Definition> _ApiSecurityDefinitionResource_DefinitionByTag = {
    2 : ApiSecurityDefinitionResource_Definition.oidc,
    0 : ApiSecurityDefinitionResource_Definition.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiSecurityDefinitionResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'apiName')
    ..aOM<ApiOpenIdConnectionDefinition>(2, _omitFieldNames ? '' : 'oidc', subBuilder: ApiOpenIdConnectionDefinition.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ApiSecurityDefinitionResource clone() => ApiSecurityDefinitionResource()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApiSecurityDefinitionResource copyWith(void Function(ApiSecurityDefinitionResource) updates) => super.copyWith((message) => updates(message as ApiSecurityDefinitionResource)) as ApiSecurityDefinitionResource;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ApiSecurityDefinitionResource create() => ApiSecurityDefinitionResource._();
  ApiSecurityDefinitionResource createEmptyInstance() => create();
  static $pb.PbList<ApiSecurityDefinitionResource> createRepeated() => $pb.PbList<ApiSecurityDefinitionResource>();
  @$core.pragma('dart2js:noInline')
  static ApiSecurityDefinitionResource getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApiSecurityDefinitionResource>(create);
  static ApiSecurityDefinitionResource? _defaultInstance;

  ApiSecurityDefinitionResource_Definition whichDefinition() => _ApiSecurityDefinitionResource_DefinitionByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set oidc(ApiOpenIdConnectionDefinition v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ApiScopes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiScopes', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
...
class ApiResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ApiResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..m<$core.String, ApiScopes>(1, _omitFieldNames ? '' : 'security', entryClassName: 'ApiResource.SecurityEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ApiScopes.create, valueDefaultOrMaker: ApiScopes.getDefault, packageName: const $pb.PackageName('nitric.proto.resources.v1'))
    ..hasRequiredFields = false
  ;
...
class ResourceDeclareResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceDeclareResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.resources.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
