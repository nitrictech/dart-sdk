...
class ClientMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<RegistrationRequest>(2, _omitFieldNames ? '' : 'registrationRequest', subBuilder: RegistrationRequest.create)
    ..aOM<MessageResponse>(3, _omitFieldNames ? '' : 'messageResponse', subBuilder: MessageResponse.create)
  ...
  @$pb.TagNumber(3)
  set messageResponse(MessageResponse v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class MessageRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'topicName')
    ..aOM<TopicMessage>(2, _omitFieldNames ? '' : 'message', subBuilder: TopicMessage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set message(TopicMessage v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MessageResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
...
class ServerMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<RegistrationResponse>(2, _omitFieldNames ? '' : 'registrationResponse', subBuilder: RegistrationResponse.create)
    ..aOM<MessageRequest>(3, _omitFieldNames ? '' : 'messageRequest', subBuilder: MessageRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set messageRequest(MessageRequest v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class RegistrationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegistrationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'topicName')
    ..hasRequiredFields = false
  ;
...
class RegistrationResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegistrationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class TopicMessage extends $pb.GeneratedMessage {
  ...
  factory TopicMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TopicMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, TopicMessage_Content> _TopicMessage_ContentByTag = {
    1 : TopicMessage_Content.structPayload,
    0 : TopicMessage_Content.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TopicMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..oo(0, [1])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TopicMessage copyWith(void Function(TopicMessage) updates) => super.copyWith((message) => updates(message as TopicMessage)) as TopicMessage;
  ...
  static $pb.PbList<TopicMessage> createRepeated() => $pb.PbList<TopicMessage>();
  @$core.pragma('dart2js:noInline')
  static TopicMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TopicMessage>(create);
  static TopicMessage? _defaultInstance;

  TopicMessage_Content whichContent() => _TopicMessage_ContentByTag[$_whichOneof(0)]!;
  void clearContent() => clearField($_whichOneof(0));
...
class TopicPublishRequest extends $pb.GeneratedMessage {
  ...
  factory TopicPublishRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TopicPublishRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TopicPublishRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'topicName')
    ..aOM<TopicMessage>(2, _omitFieldNames ? '' : 'message', subBuilder: TopicMessage.create)
    ..aOM<$11.Duration>(3, _omitFieldNames ? '' : 'delay', subBuilder: $11.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TopicPublishRequest copyWith(void Function(TopicPublishRequest) updates) => super.copyWith((message) => updates(message as TopicPublishRequest)) as TopicPublishRequest;
  ...
  static $pb.PbList<TopicPublishRequest> createRepeated() => $pb.PbList<TopicPublishRequest>();
  @$core.pragma('dart2js:noInline')
  static TopicPublishRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TopicPublishRequest>(create);
  ...
  @$pb.TagNumber(3)
  $11.Duration get delay => $_getN(2);
  @$pb.TagNumber(3)
  set delay($11.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearDelay() => clearField(3);
  @$pb.TagNumber(3)
  $11.Duration ensureDelay() => $_ensure(2);
}
...
class TopicPublishResponse extends $pb.GeneratedMessage {
  ...
  factory TopicPublishResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TopicPublishResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TopicPublishResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.topics.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TopicPublishResponse clone() => TopicPublishResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TopicPublishResponse copyWith(void Function(TopicPublishResponse) updates) => super.copyWith((message) => updates(message as TopicPublishResponse)) as TopicPublishResponse;
  ...
  static $pb.PbList<TopicPublishResponse> createRepeated() => $pb.PbList<TopicPublishResponse>();
  @$core.pragma('dart2js:noInline')
  static TopicPublishResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TopicPublishResponse>(create);
