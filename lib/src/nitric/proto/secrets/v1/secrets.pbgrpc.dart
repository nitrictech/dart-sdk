...
class SecretManagerClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$8.SecretPutResponse> put($8.SecretPutRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$put, request, options: options);
  }

  $grpc.ResponseFuture<$8.SecretAccessResponse> access(
      $8.SecretAccessRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SecretManagerServiceBase extends $grpc.Service {
  ...
  SecretManagerServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$8.SecretAccessRequest, $8.SecretAccessResponse>(
            'Access',
            access_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $8.SecretAccessRequest.fromBuffer(value),
            ($8.SecretAccessResponse value) => value.writeToBuffer()));
  }

  $async.Future<$8.SecretPutResponse> put_Pre($grpc.ServiceCall call,
      $async.Future<$8.SecretPutRequest> request) async {
    return put(call, await request);
  }

  $async.Future<$8.SecretAccessResponse> access_Pre($grpc.ServiceCall call,
      $async.Future<$8.SecretAccessRequest> request) async {
    return access(call, await request);
  }

  $async.Future<$8.SecretPutResponse> put(
      $grpc.ServiceCall call, $8.SecretPutRequest request);
  $async.Future<$8.SecretAccessResponse> access(
      $grpc.ServiceCall call, $8.SecretAccessRequest request);
}
