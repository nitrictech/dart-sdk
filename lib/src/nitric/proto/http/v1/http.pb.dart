...
class ClientMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.http.v1'), createEmptyInstance: create)
    ..aOM<HttpProxyRequest>(1, _omitFieldNames ? '' : 'request', subBuilder: HttpProxyRequest.create)
  ...
  @$pb.TagNumber(1)
  set request(HttpProxyRequest v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ServerMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.http.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class HttpProxyRequest extends $pb.GeneratedMessage {
  ...
  factory HttpProxyRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HttpProxyRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpProxyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'nitric.proto.http.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HttpProxyRequest copyWith(void Function(HttpProxyRequest) updates) => super.copyWith((message) => updates(message as HttpProxyRequest)) as HttpProxyRequest;
  ...
  static $pb.PbList<HttpProxyRequest> createRepeated() => $pb.PbList<HttpProxyRequest>();
  @$core.pragma('dart2js:noInline')
  static HttpProxyRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HttpProxyRequest>(create);
