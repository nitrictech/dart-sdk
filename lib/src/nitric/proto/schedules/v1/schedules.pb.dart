...
enum ClientMessage_Content { registrationRequest, intervalResponse, notSet }
...
class ClientMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'nitric.proto.schedules.v1'),
      createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<RegistrationRequest>(2, _omitFieldNames ? '' : 'registrationRequest',
        subBuilder: RegistrationRequest.create)
    ..aOM<IntervalResponse>(3, _omitFieldNames ? '' : 'intervalResponse',
        subBuilder: IntervalResponse.create)
  ...
  @$pb.TagNumber(3)
  set intervalResponse(IntervalResponse v) {
    setField(3, v);
  }
...
class IntervalRequest extends $pb.GeneratedMessage {
  ...
  factory IntervalRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IntervalRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IntervalRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'nitric.proto.schedules.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  IntervalRequest copyWith(void Function(IntervalRequest) updates) =>
      super.copyWith((message) => updates(message as IntervalRequest))
          as IntervalRequest;
  ...
  static $pb.PbList<IntervalRequest> createRepeated() =>
      $pb.PbList<IntervalRequest>();
  @$core.pragma('dart2js:noInline')
  static IntervalRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IntervalRequest>(create);
  static IntervalRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get scheduleName => $_getSZ(0);
  @$pb.TagNumber(1)
  set scheduleName($core.String v) {
    $_setString(0, v);
  }
...
enum ServerMessage_Content { registrationResponse, intervalRequest, notSet }
...
class ServerMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<IntervalRequest>(3, _omitFieldNames ? '' : 'intervalRequest',
        subBuilder: IntervalRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set intervalRequest(IntervalRequest v) {
    setField(3, v);
  }
...
enum RegistrationRequest_Cadence { every, cron, notSet }
...
class RegistrationRequest extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, RegistrationRequest_Cadence>
      _RegistrationRequest_CadenceByTag = {
  ...
  RegistrationRequest_Cadence whichCadence() =>
      _RegistrationRequest_CadenceByTag[$_whichOneof(0)]!;
...
class IntervalResponse extends $pb.GeneratedMessage {
  ...
  factory IntervalResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IntervalResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IntervalResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'nitric.proto.schedules.v1'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  IntervalResponse copyWith(void Function(IntervalResponse) updates) =>
      super.copyWith((message) => updates(message as IntervalResponse))
          as IntervalResponse;
  ...
  static $pb.PbList<IntervalResponse> createRepeated() =>
      $pb.PbList<IntervalResponse>();
  @$core.pragma('dart2js:noInline')
  static IntervalResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IntervalResponse>(create);
